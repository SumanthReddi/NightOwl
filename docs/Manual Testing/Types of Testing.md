...
Understanding **types of testing** helps testers decide **what to test, when to test, and why to test**.
...
Testing cannot be random.
Different types of testing focus on:
