...
While SDLC explains how software is built, **STLC explains how testing is done** in a structured and controlled way.
...
| Owner | Dev + Mgmt | QA |
| Scope | End-to-end | Test activities |
| Nature | Product-centric | Quality-centric |
