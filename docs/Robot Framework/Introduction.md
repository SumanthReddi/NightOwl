...
Robot Framework is an **open-source, keyword-driven automation framework** designed for
**acceptance testing, functional testing, and test automation**.
...
Robot Framework focuses on **readability, reusability, and maintainability**, making it suitable
